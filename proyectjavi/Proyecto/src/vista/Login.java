	...
	public Login() {
		...
		Iniciarsesionbuton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                try {
                	String comparepasswordfield = new String(Contraseña.getPassword());

                    if(TEXTUSUARIO.getText().trim().isEmpty()||comparepasswordfield.trim().isEmpty()){
                        JOptionPane.showMessageDialog(null, "Introduce los datos correctamente");
                    }else{
                  
                        String nombre = TEXTUSUARIO.getText();
                        String contrasena=comparepasswordfield;
		...
		Contraseña.setBackground(new Color(255, 222, 173));
		Contraseña.setBounds(104, 154, 124, 20);
